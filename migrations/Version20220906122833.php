 ...
 */
final class Version20220906122833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP INDEX FK_23A0E66A76ED395, ADD UNIQUE INDEX UNIQ_23A0E66A76ED395 (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP INDEX UNIQ_23A0E66A76ED395, ADD INDEX FK_23A0E66A76ED395 (user_id)');
    }
}
